...
namespace ChickenFarm
{
    public class EggCollectionManager : MonoBehaviour
    {
        ...
        public GameObject collectInstrcutionOne;
        public GameObject collectInstructionTwo;
        ...
        private bool onCollectingInstruction;
        ...
        public void ReadyToCollect()
        {
            ...
            onCollectingInstruction = true;
            collectInstrcutionOne.SetActive(true);
        }
        ...
        public void HoldEgg(string handtype, GameObject egg)
        {
            ...
            if (onCollectingInstruction)
            {
                collectInstrcutionOne.SetActive(false);
                collectInstructionTwo.SetActive(true);
            }
        }
        public void ReleaseEgg(GameObject egg)
        {
            ...
            if (onCollectingInstruction)
            {
                collectInstructionTwo.SetActive(false);
                onCollectingInstruction = false;
            }
        }
